...
VL_MODULE(Vrom) {
  ...
  public:
    static void _combo__TOP__2(Vrom__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _initial__TOP__1(Vrom__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:
